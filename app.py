...
def run_agentic_query(question, messages):
    ...
    for m in recent_msgs:
        ...
        text = m["content"].split("**Executed SQL:**")[0].strip() if role == "AI" else m["content"]
        if text:
